...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Clara\STM32CubeIDE\workspace_1.16.0\nascerr\libero_project\SmartFusionSRAM\synthesis\SFSRAM.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Clara\STM32CubeIDE\workspace_1.16.0\nascerr\libero_project\SmartFusionSRAM\designer\SFSRAM} \
    -design SFSRAM \
    -fam SmartFusion2 \
    -die PA4M500 \
    -pkg tq144 \
